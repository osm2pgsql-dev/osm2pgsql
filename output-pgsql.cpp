  ...
  rels_buffer(1024, osmium::memory::Buffer::auto_grow::yes)
{
    ...
    for (int i = 0; i < t_MAX; i++) {
        ...
        m_tables.push_back(std::shared_ptr<table_t>(new table_t(
            ...
            m_options.append, m_options.skip_optimizing, m_options.slim,
            m_options.droptemp, m_options.hstore_mode,
            m_options.enable_hstore_index, m_options.tblsmain_data,
