...
sql_test_statements=[
    ...
    ( 14, 'Gazetteer place count', 'SELECT count(*) FROM place', 4710),
    ( 15, 'Gazetteer place node count', 'SELECT count(*) FROM place WHERE osm_type = \'N\'', 989),
    ...
    ( 18, 'Gazetteer post-diff place count', 'SELECT count(*) FROM place', 4766),
    ( 19, 'Gazetteer post-diff place node count', 'SELECT count(*) FROM place WHERE osm_type = \'N\'', 1000),
    ...
    ( 22, 'Gazetteer housenumber count', 'SELECT count(*) FROM place WHERE housenumber is not null', 200),
    ( 23, 'Gazetteer post-diff housenumber count count', 'SELECT count(*) FROM place WHERE housenumber is not null', 200),
    ( 24, 'Gazetteer isin count', 'SELECT count(*) FROM place WHERE isin is not null', 240),
    ( 25, 'Gazetteer post-diff isin count count', 'SELECT count(*) FROM place WHERE isin is not null', 240),
